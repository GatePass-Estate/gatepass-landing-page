		...
		<LandingLayout>
			...
			<Section className="py-16 md:pt-30" style={{ background: LP.dark }}>
				<div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
					<img src={images.shieldImage} alt="Architecture of Trusted Access" className="mix-blend-lighten flex-1 hidden md:block" />
			...
			<Section className="py-20 md:py-28 relative overflow-hidden">
				<div className="flex flex-col items-center relative z-10 text-center max-w-3xl mx-auto -mb-16">
					...
					<Link href="/contact" className="rounded-xl px-4 py-2 font-inter-medium border transition-all flex items-center gap-1 bg-accent hover:bg-white/5 text-primary hover:text-white hover:border-white">
						Send Us A Message
					</Link>
				</div>
				<div className="inset-0 opacity-40 h-96 -mb-52" style={{ background: LP.dark }}>
					<img src={images.horizonImage} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} className="mix-blend-lighten" />
				</div>
			</Section>
		</LandingLayout>
	);
